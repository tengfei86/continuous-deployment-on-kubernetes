...
"""
  ...
  stages {
    stage("check out dspdm opengroup  project code") {
           steps {
             dir("dspdm-services") {
               git branch: '1.1.00', credentialsId: 'tong_opengroup', url: 'https://community.opengroup.org/osdu/platform/domain-data-mgmt-services/production/core/dspdm-services.git'
             }
           }
       }
